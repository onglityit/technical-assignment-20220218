...
WORKDIR /src
COPY ["Darren.Api.ValidateFile.csproj", "Darren.Api.ValidateFile/"]
RUN dotnet restore "Darren.Api.ValidateFile/Darren.Api.ValidateFile.csproj"

WORKDIR "/src/Darren.Api.ValidateFile"
COPY . .
RUN dotnet build "Darren.Api.ValidateFile.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Darren.Api.ValidateFile.csproj" \
...
Execute unit tests
```
    cd "Darren.Api.ValidateFile/test/Darren.Api.ValidateFile.Tests"
    dotnet test
```

Deploy application
```
    cd "Darren.Api.ValidateFile/src/Darren.Api.ValidateFile"
