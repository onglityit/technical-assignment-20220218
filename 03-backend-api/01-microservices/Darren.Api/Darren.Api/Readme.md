...
WORKDIR /src
COPY ["Darren.Api.csproj", "Darren.Api/"]
RUN dotnet restore "Darren.Api/Darren.Api.csproj"

WORKDIR "/src/Darren.Api"
COPY . .
RUN dotnet build "Darren.Api.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "Darren.Api.csproj" \
...
Execute unit tests
```
    cd "Darren.Api/test/Darren.Api.Tests"
    dotnet test
```

Deploy application
```
    cd "Darren.Api/src/Darren.Api"
